...
public class OTBlocks {
    ...
    public static final Block netheriteTreeLog = new OreInlaidLogBlock();
    ...
    public static final Block netheriteTreeSapling = new OreSaplingBlock(Items.NETHERITE_INGOT, BlockTags.NEEDS_DIAMOND_TOOL, 0.5, 0.4, new Identifier(N, "netherite_tree"));
    ...
    public static final Item iNetheriteTreeLog = new BlockItem(netheriteTreeLog, new FabricItemSettings().group(OreTree));
    ...
    public static final Item iNetheriteTreeSapling = new BlockItem(netheriteTreeSapling, new FabricItemSettings().group(OreTree));
    ...
    public static void register() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(N, "netherite_tree_log"), netheriteTreeLog);
        ...
        Registry.register(Registry.BLOCK, new Identifier(N, "netherite_tree_sapling"), netheriteTreeSapling);
        ...
        Registry.register(Registry.ITEM, new Identifier(N, "netherite_tree_log"), iNetheriteTreeLog);
        ...
        Registry.register(Registry.ITEM, new Identifier(N, "netherite_tree_sapling"), iNetheriteTreeSapling);
